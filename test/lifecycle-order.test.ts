...
// Spec, not a passing test yet: the full lifecycle a request should walk
// through once middleware, guards and interceptors exist. Only 'handler'
// is wired up so far, so this is expected to fail until each later stage
// is built — one more entry turns green at a time.
